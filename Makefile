...
SOURCES = \
	__init__.py \
	vl_analyse.py vl_analyse_dialog.py

PLUGINNAME = vl_analyse

PY_FILES = \
	__init__.py \
	vl_analyse.py vl_analyse_dialog.py

UI_FILES = vl_analyse_dialog_base.ui
...
QGISDIR=C:\Users\larsan\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
